    ...
    <>
      <section className="masthead -type-1 js-mouse-move-container">
        ...
        <div className="container">
          ...
          <div className="row y-gap-30 justify-content-center items-center">
            <div className="col-xl-12 col-lg-12 col-sm-12 justify-content-center items-center">
            {/* <div className="col-xl-6 col-lg-6 col-sm-10"> */}
              <div
                className="masthead__content justify-content-center items-center"
                data-aos="fade-up"
                data-aos-delay="500"
              >
